...
const labels = {
  es: {
    ...
    "shop.models.title": "Explora moldes en 3D",
    "shop.models.subtitle": "Modelos GLB interactivos: arrastra para rotar; en movil puedes pellizcar para acercar o alejar.",
    "shop.models.heroLink": "Ver renders 3D (Meshy)",
    "shop.models.prev": "Anterior",
    "shop.models.next": "Siguiente",
    "shop.models.loading": "Cargando modelo...",
    "shop.models.error": "No se pudo cargar este modelo. Comprueba el archivo .glb.",
    "shop.models.hint": "Los visores cargan los .glb desde assets/models/. La lista y nombres se configuran en assets/js/tienda-3d.js.",
    "shop.models.orientationTip": "Si un modelo se ve acostado, en tienda-3d.js pon orientation por molde (ej. -90deg 0deg 0deg o 0deg 0deg 90deg) hasta que quede vertical.",
  ...
  en: {
    ...
    "shop.models.title": "Explore molds in 3D",
    "shop.models.subtitle": "Interactive GLB models: drag to rotate; on mobile pinch to zoom in or out.",
    "shop.models.heroLink": "View 3D Meshy renders",
    "shop.models.prev": "Previous",
    "shop.models.next": "Next",
    "shop.models.loading": "Loading model...",
    "shop.models.error": "Could not load this model. Check the .glb file.",
    "shop.models.hint": "Viewers load .glb files from assets/models/. Edit the file list in assets/js/tienda-3d.js.",
    "shop.models.orientationTip": "If a model lies flat, set per-model orientation in tienda-3d.js (e.g. -90deg 0deg 0deg or 0deg 0deg 90deg) until it stands upright.",
