...
const labels = {
  es: {
    ...
    "shop.catalogNote": "El catalogo usa Supabase si rellenas assets/js/bootik-config.js; si no, assets/data/products.json.",
  ...
  en: {
    ...
    "shop.catalogNote": "The catalog uses Supabase if you fill assets/js/bootik-config.js; otherwise assets/data/products.json.",
